...
| canUseSafe                        | `bool`                                                                                            | When it is at the top, whether to maintain a safe distance from the top                                                  | `false`                                                                                       |
...
| canShowDevice                     | `bool`                                                                                            | Whether to display the information of time, power and network status                                                     | `true`                                                                                        |
| topActions                        | `List<Widget> Function(BuildContext context, bool isFullScreen)?`                                 | Widgets placed at the top right                                                                                          | `null`                                                                                        |
| canShowLock                       | `bool`                                                                                            | Whether the lockable button is displayed                                                                                 | `true`                                                                                        |
